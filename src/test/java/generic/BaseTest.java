...
public class BaseTest {
	public final String DEFAULT_URL = "https://demo.actitime.com/login.do";
	...
	@BeforeMethod
	public void preCondition(@Optional(DEFAULT_URL) String appURL, @Optional(DEFAULT_BROWSER) String browser,
			@Optional(DEFAULT_ITO) String ITO, @Optional(DEFAULT_ETO) String ETO) {
